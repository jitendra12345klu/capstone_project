# Validate web elements on dashboard excluding page content
# Validating links and buttons (all)
# Profile dropdown
...
Feature: Feature File 2
    ...
    Scenario: Validate Profile Dropdown
        ...
        Then User click on Dropdown elements and checks their respective pages
